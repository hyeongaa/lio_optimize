...
if(snu_colorization_CONFIG_INCLUDED)
  return()
endif()
set(snu_colorization_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(snu_colorization_SOURCE_PREFIX /home/hyss/lvi_slam_making/src/SNU_colorization)
  set(snu_colorization_DEVEL_PREFIX /home/hyss/lvi_slam_making/src/SNU_colorization/build/devel)
  set(snu_colorization_INSTALL_PREFIX "")
  set(snu_colorization_PREFIX ${snu_colorization_DEVEL_PREFIX})
else()
  set(snu_colorization_SOURCE_PREFIX "")
  set(snu_colorization_DEVEL_PREFIX "")
  set(snu_colorization_INSTALL_PREFIX /usr/local)
  set(snu_colorization_PREFIX ${snu_colorization_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'snu_colorization' is deprecated")
...
set(snu_colorization_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/hyss/lvi_slam_making/src/SNU_colorization/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(snu_colorization_INCLUDE_DIRS "")
  set(_include_dirs "/home/hyss/lvi_slam_making/src/SNU_colorization/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'hyeongaa <hyeongaa@snu.ac.kr>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${snu_colorization_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'snu_colorization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'snu_colorization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hyss/lvi_slam_making/src/SNU_colorization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(snu_colorization_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND snu_colorization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND snu_colorization_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT snu_colorization_NUM_DUMMY_TARGETS)
      set(snu_colorization_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::snu_colorization::wrapped-linker-option${snu_colorization_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR snu_colorization_NUM_DUMMY_TARGETS "${snu_colorization_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::snu_colorization::wrapped-linker-option${snu_colorization_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND snu_colorization_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hyss/lvi_slam_making/src/SNU_colorization/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(snu_colorization_LIBRARY_DIRS ${lib_path})
      list(APPEND snu_colorization_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'snu_colorization'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND snu_colorization_LIBRARIES ${lib})
    endif()
  endif()
...
set(snu_colorization_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${snu_colorization_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 snu_colorization_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${snu_colorization_dep}_FOUND)
      find_package(${snu_colorization_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${snu_colorization_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(snu_colorization_INCLUDE_DIRS ${${snu_colorization_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(snu_colorization_LIBRARIES ${snu_colorization_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${snu_colorization_dep}_LIBRARIES})
  _list_append_deduplicate(snu_colorization_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(snu_colorization_LIBRARIES ${snu_colorization_LIBRARIES})

  _list_append_unique(snu_colorization_LIBRARY_DIRS ${${snu_colorization_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(snu_colorization_EXPORTED_TARGETS ${${snu_colorization_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${snu_colorization_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
